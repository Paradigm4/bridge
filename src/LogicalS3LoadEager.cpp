...
class LogicalS3LoadEager : public  LogicalOperator
{
public:
    LogicalS3LoadEager(const std::string& logicalName, const std::string& alias):
...
REGISTER_LOGICAL_OPERATOR_FACTORY(LogicalS3LoadEager, "s3load_eager");
